...
const Header = () => {
  ...
  return (
    <>
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <Link to="/notifications">
                    <Button variant="ghost" size="icon" className="relative text-muted-foreground hover:text-foreground rounded-full hover:bg-secondary">
                  ...
                  <div className="relative hidden md:block" ref={profileMenuRef}>
                    ...
                    >
                      ...
                      <ChevronDown className={cn("w-4 h-4 text-muted-foreground transition-transform", isProfileMenuOpen && "rotate-180")} />
                    </Button>
                      ...
                      <div className="absolute right-0 mt-2 w-64 bg-popover/95 backdrop-blur-xl text-popover-foreground rounded-2xl shadow-xl border border-border/50 overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-200">
                        <div className="p-2">
                          ...
                          {[
                            ...
                            { icon: Search, label: "Search", path: "/athletes" },
                          ...
                          <button
                            ...
                            className="flex w-full items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-destructive/10 hover:text-destructive transition-colors text-destructive"
                          >
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="lg:hidden fixed inset-x-0 top-16 z-40 bg-background border-b border-border shadow-lg animate-in slide-in-from-top-5 duration-200">
