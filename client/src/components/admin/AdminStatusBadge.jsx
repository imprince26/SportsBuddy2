...
const statusStyles = {
  ...
  created: "border-zinc-300/50 bg-zinc-500/10 text-zinc-700 dark:text-zinc-300",
  ...
  paid: "border-emerald-300/50 bg-emerald-500/10 text-emerald-700 dark:text-emerald-400",
  refunded: "border-violet-300/50 bg-violet-500/10 text-violet-700 dark:text-violet-400",
