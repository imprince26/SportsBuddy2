...
const ManageEvents = () => {
  ...
  const handleEventAction = async (action, eventId) => {
    try {
      ...
      await api.put(`/admin/events/${eventId}/${endpoint}`, {}, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      })
  ...
  return (
    ...
    >
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">Manage events, approvals, and activities</p>
            </div>
          </div>
              ...
              <Card className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border-gray-200/20 dark:border-gray-700/20 hover:shadow-xl transition-all duration-300 relative overflow-hidden group">
                ...
                <CardContent className="p-6 relative z-10">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="p-3 rounded-xl border transition-transform duration-300 group-hover:scale-110 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/50 dark:to-purple-900/50 border-purple-200/50 dark:border-purple-700/50">
                        ...
                        {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                          ...
                          return (
                            <Button
                              ...
                              className={currentPage === page ? "bg-purple-600 text-white" : "bg-white/50 dark:bg-gray-800/50"}
                            >
                              {page}
                            </Button>
                          )
      ...
      <Dialog open={showDetailsDialog} onOpenChange={setShowDetailsDialog}>
        <DialogContent className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-gray-200/20 dark:border-gray-700/20 max-w-2xl">
          <DialogHeader>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900 dark:text-white">{selectedEvent.name}</p>
                </div>
                <div>
                  <Label className="text-sm font-medium text-gray-600 dark:text-gray-400">Category</Label>
                  <p className="text-lg text-gray-900 dark:text-white">{selectedEvent.category}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-900 dark:text-white">{selectedEvent.createdBy?.name}</p>
                </div>
              </div>
              ...
              {selectedEvent.description && (
                <div>
                  ...
                  <p className="text-gray-900 dark:text-white whitespace-pre-wrap">{selectedEvent.description}</p>
                </div>
              )}
            </div>
          )}
      ...
      <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
        <DialogContent className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-gray-200/20 dark:border-gray-700/20">
          ...
          <DialogFooter>
            ...
            <Button onClick={submitEditEvent} className="bg-purple-600 hover:bg-purple-700">
              Save Changes
            </Button>
          </DialogFooter>
        </DialogContent>
        ...
        <AlertDialogContent className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-gray-200/20 dark:border-gray-700/20">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete "<strong>{selectedEvent?.name}</strong>"? This action cannot be undone and will permanently remove the event and notify all participants.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <Dialog open={showNotificationDialog} onOpenChange={setShowNotificationDialog}>
        <DialogContent className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-gray-200/20 dark:border-gray-700/20 max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Send a notification to all participants of "{selectedEvent?.name}"
            </DialogDescription>
          </DialogHeader>
